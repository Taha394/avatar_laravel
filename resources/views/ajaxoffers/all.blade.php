        ...
        @foreach($offers as $offer)
            <tr class="offerRow{{$offer->id}}">
                ...
                <td>
                    ...
                    <a href="" offer_id="{{$offer -> id}}"  class="delete_btn btn btn-danger"> {{__('messages.deleted ajax')}}</a>
                    <a href="{{route('ajax.offers.edit', $offer -> id)}}" class="btn btn-success"> {{__('messages.edit ajax')}}</a>
                </td>
